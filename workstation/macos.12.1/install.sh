...
sudo bash -c "curl https://raw.githubusercontent.com/aumbadgah/configs/master/workstation/macos.12.1/bin/configs-install > /usr/local/bin/configs-install"
sudo chmod +x /usr/local/bin/configs-install
